...
class Locals(Enum):
    """Available local pricing and implied-volatility workflows."""
...
def run_local(local: Locals) -> None:
    """Run the selected pricing and implied-volatility workflow."""
    if local != Locals.PRICING_AND_IV:
...
if __name__ == "__main__":
    run_local(local=Locals.PRICING_AND_IV)
